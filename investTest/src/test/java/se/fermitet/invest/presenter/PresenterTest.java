...
public abstract class PresenterTest<PRESENTER extends Presenter<?, ?, ?>, POJOCLASS, MODEL extends Model<?>, VIEWINTERFACECLASS extends InvestView> {
	...
	protected abstract PRESENTER createPresenter(VIEWINTERFACECLASS view);
